...
export const metadata = {
  title: "Codelinear",
  description:
    "Welcome to Codelinear - your go-to destination for cutting-edge software solutions...",
  icons: {
    icon: "/Favicon.ico",
  },
};
  ...
  return (
    <html lang="en">
      <body className={`${geistSans.variable} ${geistMono.variable}`}>
        ...
        {/* <!-- Hotjar Tracking Code for https://www.codelinear.com/ --> */}
        {/* Hotjar Tracking Code */}
        <Script id="hotjar-script" strategy="afterInteractive">
          {`
            (function(h,o,t,j,a,r){
                h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
                h._hjSettings={hjid:6515209,hjsv:6};
