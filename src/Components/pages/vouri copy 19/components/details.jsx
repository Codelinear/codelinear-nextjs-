      ...
      <div className="flex gap-[216px] max-sm:gap-[32px] max-lg:flex-col max-1xl:gap-[56px] max-lg:py-[45px] max-sm:py-[40px] pb-[68px] pt-[92px]">
        <div className="w-[542px] widescreen:w-[900px] max-lg:w-full max-lg:h-auto flex flex-col gap-[30px] max-sm:gap-[20px]">
          ...
          <h1 className="w-[542px] widescreen:w-[100%] widescreen:text-[40px] widestscreen:text-[50px] max-sm:letter-spacing-6 max-sm:text-[24px] max-lg:w-full text-[36px] leading-[120%] letter-spacing-3">
            Codelinear partnered with Mango to create a best-in-class digital
            experience.{" "}
          </h1>
          <p className="mt-[2px] max-sm:w-full max-lg:w-[82%] text-base widescreen:text-[24px] widescreen:leading-[150%] widestscreen:text-[30px] opacity-80 max-sm:mt-[4px]">
            ...
            Here's how we addressed their challenges:{" "}
            <ul className="list-disc ml-[20px]">
              <li>
                UX/UI Design: We designed a user-friendly and visually appealing
                website and app that showcases Mango's collections in a clear
                and engaging way.
              </li>
              <li>
                React & Java Development: We built a robust and scalable
                platform that can handle high traffic volumes and future growth.
              </li>
              <li>
                Quality Assurance: Rigorous testing ensured a seamless user
                experience across all devices.
              </li>
              <li>
                Cloud Engineering: We leveraged cloud technology to provide a
                reliable and secure foundation for the platform.
              </li>
            </ul>
          </p>
        </div>
        <div className="max-xl:w-full flex flex-col max-sm:gap-[24px] max-lg:mt-0 mt-[51.5px] flex-wrap gap-[40px]">
          <div className="w-[327px] widescreen:w-[440px] flex flex-col gap-[6px] max-sm:gap-[4px]">
            ...
            <p className="text-base opacity-80 widescreen:text-[20px] widestscreen:text-[24px]">in customer conversion. </p>
          </div>
          <div className="w-[292px] widescreen:w-[440px] widescreen:w-[440px] flex flex-col gap-[6px] max-sm:gap-[4px]">
            <h1 className="text-[48px] max-sm:text-[24px] widescreen:text-[54px] widestscreen:text-[60px] max-lg:text-[36px] leading-[120%] letter-spacing-2">
              30% Increase{" "}
            </h1>
            <p className="text-base opacity-80 widescreen:text-[20px] widestscreen:text-[24px]"> in returning customers. </p>
          </div>
        </div>
      </div>
    </>
