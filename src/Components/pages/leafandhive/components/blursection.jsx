...
const Blursection = () => {
  ...
  return (
    <div className="flex justify-center max-lg:py-[45px] pt-[50px] max-sm:py-[24px] pb-[91px]  items-center">
      <div className="blur-background-lah py-[75px] max-sm:py-[41px]  h-[590px] max-sm:h-[556px]  w-[1064px] justify-between flex flex-col">
        <h1 className="w-[622px] max-md:w-full max-md:pr-[69px] max-md:ml-0 max-md:pl-[42px] ml-[80px] max-sm:ml-[0] max-sm:px-[25px] max-sm:w-full max-lg:ml-[42px] text-[48px] max-sm:text-[36px] leading-[120%] letter-spacing-2 text-[white]">
