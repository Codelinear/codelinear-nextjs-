const Desc = () => {
  return (
    <section>
      <div className="pt-[57.5px] max-lg:py-[45px] pb-[85.5px] max-xl:gap-[50px] max-sm:py-[24px] max-xl:justify-between max-2lg:gap-[20px] max-lg:flex-col max-lg:gap-[80px] max-sm:gap-[36px] flex gap-[216px]">
        <div className="flex flex-col">
          <h1 className="w-[542px] widescreen:text-[40px] widestscreen:text-[50px] widescreen:w-[700px] widestscreen:w-[1024px] mb-[56px] max-sm:mb-[12px] max-lg:mb-[21px] max-sm:text-[24px] max-lg:w-full text-[36px] leading-[120%] letter-spacing-2">
            Klassen and Smith, a leader in the US construction industry. They
            are renowned for blending traditional craftsmanship with
        ...
        <div className="w-[440px] widescreen:w-[700px] widestscreen:w-[900px] max-lg:w-[100%] max-md:w-full flex flex-col gap-[63px] max-sm:gap-[40px]">
          <div className="w-[342px] max-sm:w-full flex flex-col gap-[30px]">
            ...
            <div className="max-sm:w-[110px] bg-[#F2F2F2] widescreen:text-[20px] widestscreen:text-[24px] widestscreen:w-[170px] widescreen:py-[12px] widestscreen:py-[16px] w-[156px] py-[8px] px-[16px] text-[#000000] rounded-[8px] flex justify-center items-center text-base max-sm:text-sm font-normal font-['Archivo']">
              Construction
            </div>
          </div>
