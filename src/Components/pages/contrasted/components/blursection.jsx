...
const Blursection = () => {
  ...
  return (
    <div className="flex justify-center max-lg:py-[45px] pt-[35px] max-sm:py-[24px] pb-[91px]  items-center">
      <div className="blur-background-contrasted py-[75px] max-sm:py-[41px]  h-[590px] max-sm:h-[556px]  w-[1064px] justify-between flex flex-col">
        ...
        <div className="max-md:w-full max-sm:px-[25px]">
