...
const Hero = () => {
  return (
    <>
      ...
      <Image
        src={img}
        alt="Elevating luxurious men’s socks digital platform"
        className="max-lg:h-[387px] max-sm:h-[319px] max-lg:object-cover w-full max-lg:mb-[30px] max-sm:mb-0 mb-[37px]"
      />
    </>
  );
};
