const Desc = () => {
  return (
    <section>
      <div className="pt-[55px] max-lg:py-[45px] pb-[55px] max-xl:gap-[50px] max-sm:py-[24px] max-xl:justify-between max-2lg:gap-[20px] max-lg:flex-col max-lg:gap-[80px] max-sm:gap-[36px] flex gap-[216px]">
        <div className="flex flex-col">
          <h1 className="w-[542px] widescreen:text-[40px] widestscreen:text-[50px] widescreen:w-[700px] widestscreen:w-[1024px] mb-[56px] max-sm:mb-[12px] max-lg:mb-[21px] max-sm:text-[24px] max-lg:w-full text-[36px] leading-[120%] letter-spacing-2">
            IMAPAC is the global biopharmaceutical industry's one-stop shop for
            business connections and biopharma data.
          </h1>
        </div>
        <div className="w-[440px] widescreen:w-[700px] widestscreen:w-[900px] max-lg:w-[100%] max-md:w-full flex flex-col gap-[63px] max-sm:gap-[40px]">
          <div className="w-[342px] widescreen:w-full max-lg:w-full flex flex-col gap-[16px]">
            ...
            <div className="bg-[#F2F2F2] py-[8px] px-[16px] max-sm:w-[150px] w-[173px] text-[#000000] rounded-[8px] flex justify-center items-center text-base max-sm:text-sm font-normal font-['Archivo']">
              Biopharmaceutical
            </div>
          </div>
