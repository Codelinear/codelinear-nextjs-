    ...
    <>
       <div className="max-md:w-full pt-[100px] pb-[137px] max-lg:py-[45px] max-sm:py-[40px] flex flex-col gap-[30px] max-sm:gap-[20px]">
        ...
        <h1 className="w-[1052px] widescreen:w-[65%] max-3lg:w-full max-sm:text-[24px] widescreen:text-[54px] widestscreen:text-[60px] text-[48px] max-lg:text-[36px] leading-[120%] letter-spacing-2">
          SDU wanted orchestrate a comprehensive digital transformation that
          would streamline internal processes, elevate user experiences, and
          propel them into a new era of financial prowess.
        </h1>
      </div>
    </>
  );
