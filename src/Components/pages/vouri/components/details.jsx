      ...
      <div className="flex gap-[216px] max-sm:gap-[32px] max-lg:flex-col max-1xl:gap-[56px] max-lg:py-[45px] max-sm:py-[40px] pb-[68px] pt-[92px]">
        <div className="w-[542px] widescreen:w-[900px] max-lg:w-full max-lg:h-auto flex flex-col gap-[30px] max-sm:gap-[20px]">
          ...
          <h1 className="w-[542px] widescreen:w-[100%] widescreen:text-[40px] widestscreen:text-[50px] max-sm:letter-spacing-6 max-sm:text-[24px] max-lg:w-full text-[36px] leading-[120%] letter-spacing-3">
            We collaborated with Vuori to identify key areas for product
            enhancement, focusing on merging performance with aesthetics.
          </h1>
          <p className="mt-[2px] max-sm:w-full max-lg:w-[82%] text-base widescreen:text-[24px] widescreen:leading-[150%] widestscreen:text-[30px] opacity-80 max-sm:mt-[4px]">
            ...
            Our design-led approach ensured that every innovation aligned
            seamlessly with Vuori's brand identity. To elevate Vuori's online
            presence, we crafted a bespoke eCommerce solution tailored to their
            unique needs. The platform not only showcased their diverse product
            range but also provided a user-friendly interface that enhanced the
...
<p className="text-base opacity-80 widescreen:text-[20px] widestscreen:text-[24px]">              in sales within the first quarter
          ...
          <div className="w-[292px] widescreen:w-[440px] flex flex-col gap-[6px] max-sm:gap-[4px]">
            ...
            <p className="text-base opacity-80 widescreen:text-[20px] widestscreen:text-[24px]">in conversion rates</p>
          </div>
        </div>
      </div>
    </>
