    ...
    <>
      <div className="app-devepage mt-[40px] max-sm:mt-[23px]">
        <div className="w-full h-full pl-[80px] pb-[29px] bg-white justify-center items-center gap-[108px] inline-flex max-lg:px-[40px] max-sm:px-[20px]">
          <div className="flex justify-between w-full max-lg:w-[100%]">
              ...
              <div className="max-md:w-full">
                <div className="section w-full self-stretch max-md:w-full justify-center items-center inline-flex max-lg:justify-start">
                  <Image
                    ...
                    src={img}
                    alt="Consulting services go beyond conventional
                    solutions"
                  />
                </div>
              </div>
              ...
              <div className="self-stretch flex-col justify-start items-start gap-3 inline-flex max-xl:w-full  max-xl:h-[300px]">
                ...
                <div className=" w-[222px] widescreen:w-[300px] h-[463px] relative left-[0px] max-xl:h-[200px] max-xl:w-full">
                  ...
                  <div className=" stick_list widescreen:w-full mt-[1px] w-[197px] h-[412px] left-[25px] top-[51px] absolute flex-col justify-start items-start gap-[4px] inline-flex max-xl:flex-row max-xl:flex-wrap  max-xl:w-full  max-xl:h-[200px]  max-lg:relative max-lg:left-[0]">
                    ...
                    <Link
                      scroll={false}
                      href="#cloud-strategy-consulting"
                    ...
                    <Link
                      scroll={false}
                      href="#software-developmentconsulting"
                    ...
                    <Link
                      scroll={false}
                      href="#user-experience-consulting"
                    ...
                    <Link
                      scroll={false}
                      href="#gamification-as-a-service"
